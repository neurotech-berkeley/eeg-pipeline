...
class QuantumCore {
    ...
    processBundle(bundleAbstraction) {
        ...
        return realm_utils_1.each(bundleAbstraction.packageAbstractions, (packageAbstraction) => {
            ...
            return realm_utils_1.each(packageAbstraction.fileAbstractions, (fileAbstraction) => this.modify(fileAbstraction));
        });
    }
    treeShake() {
    ...
    render() {
        return realm_utils_1.each(this.producerAbstraction.bundleAbstractions, (bundleAbstraction) => {
            const generator = new FlatFileGenerator_1.FlatFileGenerator(this);
            generator.init();
            return realm_utils_1.each(bundleAbstraction.packageAbstractions, (packageAbstraction) => {
                return realm_utils_1.each(packageAbstraction.fileAbstractions, (fileAbstraction) => generator.addFile(fileAbstraction, this.opts.shouldEnsureES5()));
            }).then(() => {
