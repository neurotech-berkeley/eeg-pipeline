...
export declare function legoApi(fname: string, conditions: any): string;
export declare function jsCommentTemplate(fname: string, conditions: any, variables: any): string;
